...
export class Process {
    protected readonly _options: Process.Options;

    constructor(_options: Process.Options) {
    ...
    ): core.HttpResponsePromise<Mercoa.SearchPaymentGatewayProcessJobsResponse> {
    ...
    private async __find(
        request: Mercoa.paymentGateway.SearchPaymentGatewayProcessJobsRequest = {},
        requestOptions?: Process.RequestOptions,
    ): Promise<core.WithRawResponse<Mercoa.SearchPaymentGatewayProcessJobsResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.SearchPaymentGatewayProcessJobsResponse.parseOrThrow(_response.body, {
    ...
    public create(
        ...
        requestOptions?: Process.RequestOptions,
    ): core.HttpResponsePromise<Mercoa.ProcessPaymentGatewayResponse> {
    ...
    private async __create(
        request: Mercoa.ProcessPaymentGatewayRequest,
        requestOptions?: Process.RequestOptions,
    ): Promise<core.WithRawResponse<Mercoa.ProcessPaymentGatewayResponse>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.ProcessPaymentGatewayRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
        ...
        if (_response.ok) {
            return {
                data: serializers.ProcessPaymentGatewayResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
