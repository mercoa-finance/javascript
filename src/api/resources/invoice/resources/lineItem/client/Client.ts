    ...
    public async update(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `/invoice/${encodeURIComponent(serializers.InvoiceId.jsonOrThrow(invoiceId))}/line-item/${encodeURIComponent(serializers.InvoiceLineItemId.jsonOrThrow(lineItemId))}`,
            ),
            method: "PUT",
            headers: {
