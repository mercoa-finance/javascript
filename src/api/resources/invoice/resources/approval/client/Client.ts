...
export class Approval {
    ...
    public addApprover(
        ...
        return core.HttpResponsePromise.fromPromise(this.__addApprover(invoiceId, request, requestOptions));
    }
    ...
    private async __addApprover(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/invoice/${encodeURIComponent(serializers.InvoiceId.jsonOrThrow(invoiceId, { omitUndefined: true }))}/add-approver`,
            ),
            method: "POST",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError(
                    "Timeout exceeded when calling POST /invoice/{invoiceId}/add-approver.",
                );
            case "unknown":
                throw new errors.MercoaError({
    ...
    public approve(
        ...
        return core.HttpResponsePromise.fromPromise(this.__approve(invoiceId, request, requestOptions));
    }
    ...
    private async __approve(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `/invoice/${encodeURIComponent(serializers.InvoiceId.jsonOrThrow(invoiceId, { omitUndefined: true }))}/approve`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError("Timeout exceeded when calling POST /invoice/{invoiceId}/approve.");
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    public reject(
        ...
        return core.HttpResponsePromise.fromPromise(this.__reject(invoiceId, request, requestOptions));
    }
    ...
    private async __reject(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `/invoice/${encodeURIComponent(serializers.InvoiceId.jsonOrThrow(invoiceId, { omitUndefined: true }))}/reject`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError("Timeout exceeded when calling POST /invoice/{invoiceId}/reject.");
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
