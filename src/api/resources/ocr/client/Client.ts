...
export class Ocr {
    ...
    ): core.HttpResponsePromise<Mercoa.OcrResponse> {
        return core.HttpResponsePromise.fromPromise(this.__ocr(request, requestOptions));
    }

    private async __ocr(
        request: Mercoa.OcrRequest,
        requestOptions?: Ocr.RequestOptions,
    ): Promise<core.WithRawResponse<Mercoa.OcrResponse>> {
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.OcrRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip", omitUndefined: true }),
        ...
        if (_response.ok) {
            return {
                data: serializers.OcrResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError("Timeout exceeded when calling POST /ocr.");
            case "unknown":
                throw new errors.MercoaError({
    ...
    public runAsyncOcr(
        request: Mercoa.OcrRequest,
        requestOptions?: Ocr.RequestOptions,
    ): core.HttpResponsePromise<Mercoa.OcrAsyncResponse> {
        return core.HttpResponsePromise.fromPromise(this.__runAsyncOcr(request, requestOptions));
    }

    private async __runAsyncOcr(
        request: Mercoa.OcrRequest,
        requestOptions?: Ocr.RequestOptions,
    ): Promise<core.WithRawResponse<Mercoa.OcrAsyncResponse>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return {
                data: serializers.OcrAsyncResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError("Timeout exceeded when calling POST /ocr-async.");
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    public getAsyncOcr(
        jobId: string,
        requestOptions?: Ocr.RequestOptions,
    ): core.HttpResponsePromise<Mercoa.OcrJobResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getAsyncOcr(jobId, requestOptions));
    }

    private async __getAsyncOcr(
        jobId: string,
        requestOptions?: Ocr.RequestOptions,
    ): Promise<core.WithRawResponse<Mercoa.OcrJobResponse>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return {
                data: serializers.OcrJobResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError("Timeout exceeded when calling GET /ocr-async/{jobId}.");
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
