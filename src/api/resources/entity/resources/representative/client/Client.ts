...
export class Representative {
    protected readonly _options: Representative.Options;

    constructor(_options: Representative.Options) {
    ...
    ): core.HttpResponsePromise<Mercoa.RepresentativeResponse[]> {
    ...
    private async __getAll(
        entityId: Mercoa.EntityId,
        requestOptions?: Representative.RequestOptions,
    ): Promise<core.WithRawResponse<Mercoa.RepresentativeResponse[]>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/entity/${encodeURIComponent(serializers.EntityId.jsonOrThrow(entityId, { omitUndefined: true }))}/representatives`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.entity.representative.getAll.Response.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError(
                    "Timeout exceeded when calling GET /entity/{entityId}/representatives.",
                );
            case "unknown":
                throw new errors.MercoaError({
    ...
    private async __create(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `/entity/${encodeURIComponent(serializers.EntityId.jsonOrThrow(entityId, { omitUndefined: true }))}/representative`,
            ),
            method: "POST",
            headers: _headers,
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.RepresentativeRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.RepresentativeResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError(
                    "Timeout exceeded when calling POST /entity/{entityId}/representative.",
                );
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
    ...
    public get(
        ...
        return core.HttpResponsePromise.fromPromise(this.__get(entityId, representativeId, requestOptions));
    }
    ...
    private async __get(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `/entity/${encodeURIComponent(serializers.EntityId.jsonOrThrow(entityId, { omitUndefined: true }))}/representative/${encodeURIComponent(serializers.RepresentativeId.jsonOrThrow(representativeId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError(
                    "Timeout exceeded when calling GET /entity/{entityId}/representative/{representativeId}.",
                );
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
    ...
    public update(
        ...
        return core.HttpResponsePromise.fromPromise(this.__update(entityId, representativeId, request, requestOptions));
    }
    ...
    private async __update(
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.RepresentativeUpdateRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError(
                    "Timeout exceeded when calling POST /entity/{entityId}/representative/{representativeId}.",
                );
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
    ...
    public delete(
        ...
        return core.HttpResponsePromise.fromPromise(this.__delete(entityId, representativeId, requestOptions));
    }
    ...
    private async __delete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError(
                    "Timeout exceeded when calling DELETE /entity/{entityId}/representative/{representativeId}.",
                );
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
