...
export class NotificationPolicy {
    ...
    public async getAll(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `/entity/${encodeURIComponent(serializers.EntityId.jsonOrThrow(entityId))}/notification-policies`,
            ),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return serializers.entity.notificationPolicy.getAll.Response.parseOrThrow(_response.body, {
    ...
    public async get(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `/entity/${encodeURIComponent(serializers.EntityId.jsonOrThrow(entityId))}/notification-policy/${encodeURIComponent(serializers.NotificationType.jsonOrThrow(notificationType))}`,
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return serializers.NotificationPolicyResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
    ...
    public async update(
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.NotificationPolicyRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
