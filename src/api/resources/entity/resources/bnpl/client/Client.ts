...
export class Bnpl {
     ...
     *
     * @param {string} entityId - The ID of the entity to get loans for
    ...
    public getLoans(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getLoans(entityId, requestOptions));
    }

    private async __getLoans(
        entityId: string,
        requestOptions?: Bnpl.RequestOptions,
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `entity/${encodeURIComponent(entityId)}/bnpl/loans`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.entity.bnpl.getLoans.Response.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError("Timeout exceeded when calling GET /entity/{entityId}/bnpl/loans.");
            case "unknown":
                throw new errors.MercoaError({
