...
export class Bnpl {
     ...
     */
    public async getLoans(entityId: string, requestOptions?: Bnpl.RequestOptions): Promise<Mercoa.BnplLoanResponse[]> {
        ...
        if (_response.ok) {
            return serializers.entity.bnpl.getLoans.Response.parseOrThrow(_response.body, {
