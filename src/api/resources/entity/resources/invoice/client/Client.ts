...
export class Invoice {
    ...
    private async __find(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/entity/${encodeURIComponent(serializers.EntityId.jsonOrThrow(entityId, { omitUndefined: true }))}/invoices`,
            ),
            method: "GET",
            headers: _headers,
    ...
    public metrics(
        ...
        return core.HttpResponsePromise.fromPromise(this.__metrics(entityId, request, requestOptions));
    }
    ...
    private async __metrics(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `/entity/${encodeURIComponent(serializers.EntityId.jsonOrThrow(entityId, { omitUndefined: true }))}/invoice-metrics`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        if (_response.ok) {
            return {
                data: serializers.entity.invoice.metrics.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    public download(
        ...
        return core.HttpResponsePromise.fromPromise(this.__download(entityId, request, requestOptions));
    }
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `/entity/${encodeURIComponent(serializers.EntityId.jsonOrThrow(entityId, { omitUndefined: true }))}/invoices/download`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
