...
export declare namespace InvoiceTemplate {
...
export class InvoiceTemplate {
     ...
     *
     * @param {Mercoa.invoiceTemplate.GetAllInvoiceTemplatesRequest} request
     * @param {InvoiceTemplate.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<Mercoa.FindInvoiceTemplateResponse> {
    ...
    private async __find(
        request: Mercoa.invoiceTemplate.GetAllInvoiceTemplatesRequest = {},
        requestOptions?: InvoiceTemplate.RequestOptions,
    ): Promise<core.WithRawResponse<Mercoa.FindInvoiceTemplateResponse>> {
        const {
            entityId,
            startDate,
            endDate,
        ...
        if (_response.ok) {
            return {
                data: serializers.FindInvoiceTemplateResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError("Timeout exceeded when calling GET /invoice-templates.");
            case "unknown":
                throw new errors.MercoaError({
    ...
    /**
     * @param {Mercoa.InvoiceTemplateCreationRequest} request
     * @param {InvoiceTemplate.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Mercoa.BadRequest}
     * @throws {@link Mercoa.Unauthorized}
    ...
    public create(
        ...
        requestOptions?: InvoiceTemplate.RequestOptions,
    ): core.HttpResponsePromise<Mercoa.InvoiceTemplateResponse> {
    ...
    private async __create(
        request: Mercoa.InvoiceTemplateCreationRequest,
        requestOptions?: InvoiceTemplate.RequestOptions,
    ): Promise<core.WithRawResponse<Mercoa.InvoiceTemplateResponse>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.InvoiceTemplateCreationRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
        ...
        if (_response.ok) {
            return {
                data: serializers.InvoiceTemplateResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError("Timeout exceeded when calling POST /invoice-template.");
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    public get(
        ...
        return core.HttpResponsePromise.fromPromise(this.__get(invoiceTemplateId, requestOptions));
    }
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `invoice-template/${encodeURIComponent(serializers.InvoiceTemplateId.jsonOrThrow(invoiceTemplateId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError(
                    "Timeout exceeded when calling GET /invoice-template/{invoiceTemplateId}.",
                );
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
    ...
    /**
     * @param {Mercoa.InvoiceTemplateId} invoiceTemplateId - Invoice Template ID
     * @param {Mercoa.InvoiceTemplateUpdateRequest} request
     * @param {InvoiceTemplate.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Mercoa.BadRequest}
     * @throws {@link Mercoa.Unauthorized}
    ...
    public update(
        ...
        return core.HttpResponsePromise.fromPromise(this.__update(invoiceTemplateId, request, requestOptions));
    }
    ...
    private async __update(
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.InvoiceTemplateUpdateRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError(
                    "Timeout exceeded when calling POST /invoice-template/{invoiceTemplateId}.",
                );
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
    ...
    public delete(
        ...
        return core.HttpResponsePromise.fromPromise(this.__delete(invoiceTemplateId, requestOptions));
    }
    ...
    private async __delete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MercoaTimeoutError(
                    "Timeout exceeded when calling DELETE /invoice-template/{invoiceTemplateId}.",
                );
            case "unknown":
                throw new errors.MercoaError({
                    message: _response.error.errorMessage,
