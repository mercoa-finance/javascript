    ...
    public async addApprover(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `/invoice-template/${encodeURIComponent(serializers.InvoiceTemplateId.jsonOrThrow(invoiceTemplateId))}/add-approver`,
            ),
            method: "POST",
            headers: {
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `/invoice-template/${encodeURIComponent(serializers.InvoiceTemplateId.jsonOrThrow(invoiceTemplateId))}/approve`,
            ),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MercoaEnvironment.Production,
                `/invoice-template/${encodeURIComponent(serializers.InvoiceTemplateId.jsonOrThrow(invoiceTemplateId))}/reject`,
            ),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
