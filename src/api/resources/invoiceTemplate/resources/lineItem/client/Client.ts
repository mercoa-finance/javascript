...
export class LineItem {
    ...
    public update(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__update(invoiceTemplateId, lineItemId, request, requestOptions),
        );
    }
    ...
    private async __update(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/invoice-template/${encodeURIComponent(serializers.InvoiceTemplateId.jsonOrThrow(invoiceTemplateId, { omitUndefined: true }))}/line-item/${encodeURIComponent(serializers.InvoiceLineItemId.jsonOrThrow(lineItemId, { omitUndefined: true }))}`,
            ),
            method: "PUT",
            headers: _headers,
