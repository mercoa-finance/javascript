...
export const RepresentativeResponse: core.serialization.ObjectSchema<
    serializers.entity.RepresentativeResponse.Raw,
    Mercoa.entity.RepresentativeResponse
> = core.serialization.object({
    id: core.serialization.lazy(async () => (await import("../../../../..")).entity.RepresentativeId),
...
export declare namespace RepresentativeResponse {
    interface Raw {
        id: serializers.entity.RepresentativeId.Raw;
