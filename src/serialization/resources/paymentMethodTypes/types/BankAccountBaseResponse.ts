...
export const BankAccountBaseResponse: core.serialization.ObjectSchema<
    serializers.BankAccountBaseResponse.Raw,
    Mercoa.BankAccountBaseResponse
...
export declare namespace BankAccountBaseResponse {
    interface Raw {
