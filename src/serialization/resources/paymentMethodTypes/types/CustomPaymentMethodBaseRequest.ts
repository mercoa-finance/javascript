...
export const CustomPaymentMethodBaseRequest: core.serialization.ObjectSchema<
    serializers.CustomPaymentMethodBaseRequest.Raw,
    Mercoa.CustomPaymentMethodBaseRequest
...
export declare namespace CustomPaymentMethodBaseRequest {
    interface Raw {
