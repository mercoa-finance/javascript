...
export const CounterpartiesResponse: core.serialization.ObjectSchema<
    serializers.CounterpartiesResponse.Raw,
    Mercoa.CounterpartiesResponse
...
export declare namespace CounterpartiesResponse {
    interface Raw {
