...
describe("LineItem", () => {
    test("update", async () => {
        ...
        server
            .mockEndpoint()
            .put("/invoice/in_d8f68285-1c6d-4d5a-a9e3-252c3180fac4/line-item/inli_8aa84cb8-2ae7-4579-8fa3-87586e7c14a7")
        ...
        const response = await client.invoice.lineItem.update(
