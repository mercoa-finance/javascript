...
describe("LineItem", () => {
    test("update", async () => {
        ...
        server
            .mockEndpoint()
            .put(
                "/invoice-template/invt_13c07096-5848-4aeb-ae7d-6576289034c4/line-item/inli_8aa84cb8-2ae7-4579-8fa3-87586e7c14a7",
            )
        ...
        const response = await client.invoiceTemplate.lineItem.update(
