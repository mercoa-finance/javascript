...
describe("Invoice", () => {
    test("find", async () => {
        ...
        server
            .mockEndpoint()
            .get("/entityGroup/entg_8545a84e-a45f-41bf-bdf1-33b42a55812c/invoices")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.entityGroup.invoice.find("entg_8545a84e-a45f-41bf-bdf1-33b42a55812c", {
    ...
    test("download", async () => {
        ...
        server
            .mockEndpoint()
            .get("/entityGroup/entg_8545a84e-a45f-41bf-bdf1-33b42a55812c/invoices/download")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.entityGroup.invoice.download("entg_8545a84e-a45f-41bf-bdf1-33b42a55812c", {
            format: "CSV",
            excludeReceivables: true,
        });
        expect(response).toEqual({
    ...
    test("metrics", async () => {
        ...
        server
            .mockEndpoint()
            .get("/entityGroup/entg_8545a84e-a45f-41bf-bdf1-33b42a55812c/invoice-metrics")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.entityGroup.invoice.metrics("entg_8545a84e-a45f-41bf-bdf1-33b42a55812c", {
