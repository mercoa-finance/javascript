...
describe("Transaction", () => {
    test("find", async () => {
                            ...
                            transactions: [
                                {
                                    ...
                                    payer: {
                                        ...
                                        accounts: [
                                            { accountId: "85866843", postalCode: "94105", nameOnAccount: "John Doe" },
                                        ],
                                        paymentMethods: [
                                            {
                                                id: "pm_4794d597-70dc-4fec-b6ec-c5988e759769",
        ...
        const response = await client.transaction.find({
        ...
        expect(response).toEqual({
            ...
            data: [
                ...
                },
                {
                    ...
                    amount: 10000,
                    currency: "USD",
                    mailedOnDate: new Date("2024-01-01T00:00:00.000Z"),
                    payerId: "ent_bb08e72f-19f8-45f3-bcf9-46fdc46cb2f4",
                    payer: {
                        id: "ent_8545a84e-a45f-41bf-bdf1-33b42a55812c",
                        foreignId: "MY-DB-ID-12345",
    ...
    test("get", async () => {
        ...
        server
            .mockEndpoint()
            .get("/transaction/trx_bb08e72f-19f8-45f3-bcf9-46fdc46cb2f4")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.transaction.get("trx_bb08e72f-19f8-45f3-bcf9-46fdc46cb2f4");
        expect(response).toEqual({
            type: "bankAccountToBankAccount",
            id: "trx_bb08e72f-19f8-45f3-bcf9-46fdc46cb2f4",
            status: "COMPLETED",
    ...
    test("download", async () => {
        ...
        const response = await client.transaction.download({
            format: "CSV",
        });
        expect(response).toEqual({
