...
describe("Invoice", () => {
    test("find", async () => {
        ...
        server
            .mockEndpoint()
            .get("/entity/ent_8545a84e-a45f-41bf-bdf1-33b42a55812c/invoices")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.entity.invoice.find("ent_8545a84e-a45f-41bf-bdf1-33b42a55812c", {
    ...
    test("metrics", async () => {
        ...
        server
            .mockEndpoint()
            .get("/entity/ent_8545a84e-a45f-41bf-bdf1-33b42a55812c/invoice-metrics")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.entity.invoice.metrics("ent_8545a84e-a45f-41bf-bdf1-33b42a55812c", {
    ...
    test("download", async () => {
        ...
        server
            .mockEndpoint()
            .get("/entity/ent_8545a84e-a45f-41bf-bdf1-33b42a55812c/invoices/download")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.entity.invoice.download("ent_8545a84e-a45f-41bf-bdf1-33b42a55812c", {
            format: "CSV",
        });
        expect(response).toEqual({
